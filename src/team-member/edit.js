	...
	return (
		<>
			...
			<div {...useBlockProps()}>
				{url && (
					<div
						className={`wp-block-sotech-blocks-team-member-img${isBlobURL(url) ? ' is-loading' : ''
							}`}
					>
						<img src={url} alt={alt} />
				...
				<div className="wp-block-sotech-blocks-team-member-social-links">
					<ul>
						<DndContext sensors={sensors} onDragEnd={handleDragEnd} modifiers={[restrictToHorizontalAxis]}>
							...
							>
								{socialLinks.map((item, index) => {
									return (
										<SortableItem key={`${item.icon}-${item.link}`} 
						...
						{isSelected && (
							<li className="wp-block-sotech-blocks-team-member-add-icon-li">
								<Tooltip
									text={__(
										'Add Social Link',
										'team-members'
				...
				{selectedLink !== undefined && (
					<div className="wp-block-sotech-blocks-team-member-link-form">
						<TextControl
